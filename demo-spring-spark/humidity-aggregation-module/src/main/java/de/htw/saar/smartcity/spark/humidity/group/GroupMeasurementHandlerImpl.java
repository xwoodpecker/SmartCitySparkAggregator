...
public class GroupMeasurementHandlerImpl extends GroupMeasurementHandler {
    ...
    public GroupMeasurementHandlerImpl(StorageWrapper storageWrapper, Publisher publisher, ProducerService producerService, GroupService groupService, CombinatorService combinatorService) {
